...
/// <summary>
/// IVectorizationService en memoria para tests unitarios de DimensionService:
/// permite registrar de antemano el/los VectorVersion "ya generados" que
/// FindVector debe devolver, sin depender de VectorizationService real ni de
/// VTracer. GenerateVectorAsync no se usa desde DimensionService (solo
/// FindVector), así que lanza si se llega a invocar -- mismo criterio que
/// Checking.Tests.FakeVectorizationService.
/// </summary>
internal sealed class FakeVectorizationService : IVectorizationService
{
    ...
    public Task<VectorResult> GenerateVectorAsync(
        ...
        throw new NotSupportedException("DimensionService no debería llamar a GenerateVectorAsync.");
