...
/// <summary>
/// IVectorizationService en memoria para tests unitarios de CheckService:
...
/// VTracer. GenerateVectorAsync no se usa desde CheckService (solo
/// FindVector), así que lanza si se llega a invocar -- mismo criterio que
/// Simplification.Tests.FakeVectorizationService.
/// </summary>
internal sealed class FakeVectorizationService : IVectorizationService
{
    ...
    public Task<VectorResult> GenerateVectorAsync(
        ...
        throw new NotSupportedException("CheckService no debería llamar a GenerateVectorAsync.");
