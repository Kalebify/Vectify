...
/// <summary>
/// IVectorizationService en memoria para tests unitarios de ExportService:
...
/// VTracer. GenerateVectorAsync no se usa desde ExportService (solo
/// FindVector), así que lanza si se llega a invocar -- mismo criterio que
/// Dimensioning.Tests.FakeVectorizationService.
/// </summary>
internal sealed class FakeVectorizationService : IVectorizationService
{
    ...
    public Task<VectorResult> GenerateVectorAsync(
        ...
        throw new NotSupportedException("ExportService no debería llamar a GenerateVectorAsync.");
